...
import 'package:app/direction_indicator.dart';
...
class _CameraViewState extends State<CameraView> {
  ...
  Widget _liveBody() {
    List<String> lookedWhere = [];

    widget.directions.where((element) => element.hasLooked).isEmpty
        ? lookedWhere.clear()
        : lookedWhere.add(
            'Looked ${widget.directions.where((element) => element.hasLooked).first.name}');
      ...
      child: Stack(
        ...
        children: [
          ...
          Positioned(
            ...
            right: 50,
            child: Column(
              children: [DirectionIndicator(directions: widget.directions)],
            ),
          ),
        ],
      ),
